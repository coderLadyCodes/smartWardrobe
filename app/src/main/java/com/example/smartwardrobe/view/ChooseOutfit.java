package com.example.smartwardrobe.view;//package com.example.smartwardrobe.view;
//
...
public class ChooseOutfit extends Fragment {
    ...
    private Outfit generateOutfit(String warmth, boolean comfort, boolean fancy, boolean loose, String color) {
        ...
        if (garmentList == null) {
            // Handle the case when the garmentList is null
            // You can return an empty outfit or display an error message.
            return new Outfit(); // This creates an empty outfit, modify as needed.
        }
